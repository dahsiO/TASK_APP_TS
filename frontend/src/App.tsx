  ...
  if (page === "login") {
    return (
      <div className="fixed inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-auto">
        ...
        <div className="relative w-full max-w-md mx-auto min-h-full flex items-center justify-center p-4">
          {/* Glass Card */}
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl w-full">
            {/* Logo/Icon */}
